...
includelib \masm32\lib\kernel32.lib ;  ExitProcess, LoadLibrary, GetProcAddress, FreeLibrary
...
.data
    ...
    SutulovProcedureName db "SutulovPerformCalculation", 0
    SutulovLibraryName db "8-20-IM-12-Sutulov-lib.dll", 0
...
.data?
    ...
    SutulovPerformCalculation dd ?
    SutulovLibrary dd ?

.code
main:

    invoke LoadLibrary, offset SutulovLibraryName
    mov SutulovLibrary, eax

    invoke GetProcAddress, SutulovLibrary, offset SutulovProcedureName
    mov SutulovPerformCalculation, eax
    ...
    loopToIterateThroughArrays:
        ...
        push ebx
        lea ebx, SutulovDArray[edi*8]
        push ebx
        lea ebx, SutulovCArray[edi*8]
        push ebx
        lea ebx, SutulovBArray[edi*8]
        push ebx
        lea ebx, SutulovAArray[edi*8]
        push ebx

        call [SutulovPerformCalculation]
    ...
    exitLoop:
        invoke FreeLibrary, SutulovLibrary
